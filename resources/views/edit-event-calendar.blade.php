                ...
                <form action="{{ route('updateCalendarEvent', $eventData->id) }}" method="post" class="py-3">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" name="daterange" id="daterange"
                            class="w-full px-4 py-2 mt-2 pl-9 border text-sm border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
