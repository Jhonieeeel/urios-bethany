                ...
                <div class="inline-block min-w-full p-1.5 align-middle">
                    <div class="divide-y divide-gray-200">
                        <div class="flex items-center py-3">
                            ...
                            <div class="ms-auto">
                                <a href="#" class="inline-flex items-center rounded-full border border-gray-300 bg-gray-50 px-4 py-2 text-sm font-medium text-gray-800 transition duration-150 ease-in-out hover:bg-gray-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" class="size-4 shrink-0 me-2">
                                        <path
                                    ...
                                    @forelse ($residents as $resident)
                                        <tr class="transition duration-150 ease-in-out hover:bg-gray-100">
                                            <td
                                                ...
                                                {{ str_pad($resident->id, 3, '0', STR_PAD_LEFT) }}
                                            </td>
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4 text-end text-sm text-gray-800">
                                                {{ $resident->admitted_at->format('m/d/Y') }}
                                            </td>
