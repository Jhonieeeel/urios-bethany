<ul
    ...
    <li class=" flex flex-col space-y-3 group-hover:justify-start overflow-hidden px-1  items-center">
        <a href="{{ route('home') }}"
            class="overflow-x-hidden flex items-center hover:bg-green-700 transition-all  hover:text-white w-full rounded-full ">
        ...
        <a href="{{ route('calendar') }}"
            ...
            <div class="bg-green-700 p-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24"
                    ...
                    stroke-linejoin="round" class="lucide lucide-calendar rounded-full bg text-gray-200 bg-green-700">
                    <path d="M8 2v4" />
                    <path d="M16 2v4" />
