    ...
    <ul
        ...
        <li
            ...
            <div class="bg-green-700 p-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none"
                    ...
                    class="size-4 shrink-0 rounded-full bg text-gray-200 bg-green-700">
        ...
        <li class="flex items-center hover:bg-green-700 transition-all  hover:text-white w-full rounded-full">
            <div class="bg-green-700 p-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="size-4 shrink-0 text-gray-200 bg-green-700">
        ...
        <li
            ...
            <div class="bg-green-700 p-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="size-2 shrink-0 rounded-full bg text-gray-200 bg-green-700">
        ...
        <li class="flex items-center hover:bg-green-700 transition-all  hover:text-white w-full rounded-full ">
            <div class="bg-green-700 p-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="size-4 shrink-0 rounded-full text-gray-200 bg-green-700">
        ...
        <li class="flex items-center hover:bg-green-700 transition-all  hover:text-white w-full rounded-full ">
            <div class="bg-green-700 p-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24"
                    ...
                    stroke-linejoin="round" class="size-4 shrink-0 rounded-full bg text-gray-200 bg-green-700"">
                    <path d="M13 12h8" />
                    <path d="M13 18h8" />
                    <path d="M13 6h8" />
                    <path d="M3 12h1" />
